...
#define VERSION "</xsl:text><xsl:value-of select="//version" /><xsl:text>"
    ...
    <xsl:text>
static int pre_commit_config(Tracee *, const Cli *, size_t, char *const *, size_t);
static int post_commit_config(Tracee *, const Cli *, size_t, char *const *, size_t);
</xsl:text>
    <xsl:text>
static Cli proot_cli = {
	...
	.post_commit_config = post_commit_config,
