...
int main()
{
	...
	if (errno != EISDIR) {
		perror
		    ("unlink top-bug-138/a should have failed with EISDIR");
		exit(EXIT_FAILURE);
	}
	...
	if (errno != ENOTEMPTY) {
		perror
		    ("rmdir top-bug-138/a should have failed with ENOTEMPTY");
		exit(EXIT_FAILURE);
	}
	...
	if (errno != EACCES) {
		perror
		    ("unlink top-bug-138/a/b should have failed with EACCES");
		exit(EXIT_FAILURE);
	}
	...
	if (errno != EACCES) {
		perror
		    ("rmdir top-bug-138/a/b should have failed with EACCES");
		exit(EXIT_FAILURE);
	}
	...
	if (errno != EACCES) {
		perror
		    ("stat top-bug-138/a/b should have failed with EACCES");
		exit(EXIT_FAILURE);
	}
	...
	if (errno != ENOTEMPTY) {
		perror
		    ("unlink top-bug-138/a should have failed with ENOTEMPTY");
		exit(EXIT_FAILURE);
	}
	...
	if (errno != EISDIR) {
		perror
		    ("unlink top-bug-138 should have failed with EISDIR");
		exit(EXIT_FAILURE);
	}
	...
	if (errno != ENOTEMPTY) {
		perror
		    ("rmdir top-bug-138 should have failed with ENOTEMPTY");
		exit(EXIT_FAILURE);
	}
