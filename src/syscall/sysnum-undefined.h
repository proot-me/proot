...
#undef PR_writev
#undef PR_x32_execve
#undef PR_x32_get_robust_list
#undef PR_x32_ioctl
#undef PR_x32_kexec_load
#undef PR_x32_move_pages
#undef PR_x32_mq_notify
#undef PR_x32_preadv
#undef PR_x32_process_vm_readv
#undef PR_x32_process_vm_writev
#undef PR_x32_ptrace
#undef PR_x32_pwritev
#undef PR_x32_readv
#undef PR_x32_recvfrom
#undef PR_x32_recvmmsg
#undef PR_x32_recvmsg
#undef PR_x32_rt_sigaction
#undef PR_x32_rt_sigpending
#undef PR_x32_rt_sigqueueinfo
#undef PR_x32_rt_sigreturn
#undef PR_x32_rt_sigtimedwait
#undef PR_x32_rt_tgsigqueueinfo
#undef PR_x32_sendmmsg
#undef PR_x32_sendmsg
#undef PR_x32_set_robust_list
#undef PR_x32_sigaltstack
#undef PR_x32_timer_create
#undef PR_x32_vmsplice
#undef PR_x32_waitid
#undef PR_x32_writev
